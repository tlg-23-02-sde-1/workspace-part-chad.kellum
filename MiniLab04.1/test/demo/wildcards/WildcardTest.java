...
public class WildcardTest {
     ...
     */
    private double sum(Collection<? extends Number> values) { // ? collection of anything as long it matches in the class
        double sum = 0.0;                                       // double is part of number class, so Collection<Double> has doubles.
