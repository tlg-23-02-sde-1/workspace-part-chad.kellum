...
public class EmployeeFactoryTest {
    ...
    public void createEmployee_shouldReturnSalariedEmployee_whenTypeSE() {
       ...
       // check that 'emp' is EXACTLY a SalariedEmployee object
        ...
        // downcast 'emp' reference to more specific type of SalariedEmployee
     ...
     */
    @Test
    public void createEmployeeHourly_shouldReturnSalariedEmployee_whenTypeHE() {
    ...
    @Test
    public void createEmployee_shouldThrowIAException_invalidType() {
    ...
    public void createEmployee_shouldThrowIAException_whenInvalidType_expectedAttribute() {
       seMap.put("type", "INVALID-TYPE");
